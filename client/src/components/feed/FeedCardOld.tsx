...
import { Play, Clock, BookOpen, Edit2, Trash2, Loader2 } from "lucide-react"; // Add Trash2
import { useDeleteContent } from "@/hooks/use-content"; // Import the hook
...
{/* Action Buttons Container */}
      <div className="absolute bottom-24 left-6 z-20 flex flex-col gap-3">
        ...
        <button 
          onClick={() => onEdit(item)}
          className="w-12 h-12 bg-black/20 backdrop-blur-md border border-white/10 rounded-full flex items-center justify-center text-white/70 hover:text-white hover:bg-white/10 transition-all"
        >
        ...
        <button 
          ...
          className="w-12 h-12 bg-red-500/20 backdrop-blur-md border border-red-500/20 rounded-full flex items-center justify-center text-red-400 hover:text-red-300 hover:bg-red-500/30 transition-all"
        >
